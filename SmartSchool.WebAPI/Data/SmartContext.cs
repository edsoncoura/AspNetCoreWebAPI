...
namespace SmartSchool.WebAPI.Data
{
    ...
    public class SmartContext : DbContext
    {
        ...
        //Passa o relacionamento de (N pra N)
        //Com isso se cria o "onModelCreating" que recebe o "ModelBuilder" q recebe como parametro o "builder"
        //Esse metodo (onModelCreating), será executado durante a criação e popularização do Banco Dados
        //Criando o relacionamento (N pra N), do Aluno para a Disciplina
